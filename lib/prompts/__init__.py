...
Note: Project context files (app_spec.txt, harness_capabilities.md, etc.) stay in
project_context/ and are NOT copied to generations/. The agent reads them from
project_context/ directly.
"""

from pathlib import Path
from typing import Optional

from lib.core.paths import get_project_context_dir
...
class PromptLoader:
    ...
    def __init__(
        ...
        if project_context_dir is None:
            ...
            project_context_dir = get_project_context_dir()
